...
//        binding.drawerLayout.setDrawerLockMode(DrawerLayout.LOCK_MODE_LOCKED_CLOSED, GravityCompat.START)
        ...
        binding.navView.setNavigationItemSelectedListener(NavigationView.OnNavigationItemSelectedListener { item ->
            ...
            when (item.itemId) {
                R.id.profile -> {
                    val intentProfile =
                        Intent(this@ParentProfileActivity, ParentProfileActivity::class.java)
                    startActivity(intentProfile.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP))
                    return@OnNavigationItemSelectedListener true
                }
                R.id.childrenProfile -> {
                    val intentAbout = Intent(this@ParentProfileActivity, ChildProfileActivity::class.java)
                    startActivity(intentAbout.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP))
                    return@OnNavigationItemSelectedListener true
                }
                R.id.trips -> {
                    val intentMyVehicles =
                        Intent(this@ParentProfileActivity, TripsActivity::class.java)
                    startActivity(intentMyVehicles.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP))
                    return@OnNavigationItemSelectedListener true
                }
                R.id.map -> {
                    val intentMyVehicles =
                        Intent(this@ParentProfileActivity, MainActivity::class.java)
                    startActivity(intentMyVehicles.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP))
                    return@OnNavigationItemSelectedListener true
                }
//                R.id.logout -> {
//                    editor.clear()
//                    editor.apply()
//                    val intentLogout = Intent(this@ParentProfileActivity, MainActivity::class.java)
